...
namespace Beesys.Wasp.AddIn
{
    ...
    public partial class TimeFormat : UCBaseEngineAddin
    {
        ...
        private static string _timeFormat = "Time Format:";//S.No.: -06
        private static string _tomorrowDateFormat = "Tomorrow's Date Format:";//S.No.: -06
        private static string _todayDateFormat = "Today's Date Format:";//S.No.: -06
        private static string _description = "Description";//S.No.: -06
        private static string _time = "Time";//S.No.: -06
        private static string _hour = "Hour";//S.No.: -06
        private static string _minute = "Minute";//S.No.: -06
        private static string _second = "Second";//S.No.: -06
        ...
        public TimeFormat()
        {
            ...
            InitializeComponent();
            base.sRTFFileName = "ClockAddinRTF.rtf";// S.No.: -06
        }
        ...
        public override void OnOkClick()// S.No.: -06
        {
            try
            {
        ...
        {
            // this.btnOk.Text = Culture.GetResourceValue(ClockAddinConstants.BtnOKtxt);
            // this.btnCancel.Text = Culture.GetResourceValue(ClockAddinConstants.BtnCncltxt);
        ...
        public void InitHelp(IWService obj)// S.No.: -06
        {
            m_objIWService = obj;
            base.WService = obj;
            ...
            try
            {
                ...
                if (sarrFormats != null && sarrFormats.Length >= 2)
                {
                    ...
                    if (iIndex > -1)
                        ...
                        txtbxTodaysFormat.Text = sarrFormats[1]; // S.No.: -05
                    ...
                    if (iIndex > -1)
                        ...
                        txtbxTomorrowsFormat.Text = sarrFormats[2]; //S.No.: -05
                }
            }
            catch (Exception ex)
            {
